...
const LINE_HEADER = {
  ...
  Authorization: `Bearer m/qyU5b/MOlSGl/YjjDIOj5aBqZcMN7G1Rq3IchjDGb8MLN3LenRv2KbP87mThFt94gn8sWfXqtEYLxejrt4DRZiuldtRWd3QnCZDua8SaxbQKlsrt0fg/lzA1Pd+hQIjLQ1J/YBuI8Gw8+OlpS2EAdB04t89/1O/w1cDnyilFU=`
};

const THAIPOST_TOKEN =
  "GwZCZ?VzYdL=PwWlCGCyVeMDG|I~SCT1ZRWBHvUfPMUlQ|B7M#B3HHJ8B!GPCVI?SrU|QiZaMlSXS*MZKPJtE!H/D;JeYGJSG$J1";

exports.faisolWebHook = functions.region(REGION).https.onRequest((req, res) => {
...
exports.faisolLineBot = functions.region(REGION).https.onRequest((req, res) => {
